...
int main(void) {
{
	...
	//set value with value 20,19
    memset(buffer, 20, 9);   //last byte should be null
    printf("buffer (memset with value 20): %s",buffer); 
	printf(".\n");      
    printf("buffer (memset with value 20 printing integer values:\n*** LAST VALUE WILL BE NULL ***):\n");
